...
console.log("\n");
console.log(
    chalk.bgMagentaBright.bold("1. Basic 5 Fundamentals"), 
    chalk.bgCyan.bold("2. Quran Kareem"), 
    chalk.bgYellow.bold("3. Eid's"), 
    chalk.bgGray.bold("4. Prophet's"), 
    chalk.bgRedBright.bold("5. Sahabah"), 
    chalk.bgGreen.bold("6. Hadiths"), 
    chalk.bgBlue.bold("7. Books"),
);
...
if (menuAnswer.menu === "1. Basic 5 Fundamentals") {
    ...
    console.log("\n");
    console.log(
    chalk.bgMagentaBright.bold("1.1 Toheed (Fait)"), 
    chalk.bgCyan.bold("1.2 Salah (Prayer)"), 
    chalk.bgYellow.bold("1.3 Sawm (Fasting)"), 
    chalk.bgGray.bold("1.4 Zakat (Charity)"), 
    chalk.bgRedBright.bold("1.5 Hajj (Pilgrimage)"), 
    );
    ...
    // For Swalah
        ...
        console.log("\n");
        console.log(
            chalk.bgMagentaBright.bold("1.1.1 Fajar"), 
            chalk.bgCyan.bold("1.1.2 Zohar"), 
            chalk.bgYellow.bold("1.1.3 Asr"), 
            chalk.bgGray.bold("1.1.4 Maghrib"), 
            chalk.bgRedBright.bold("1.1.5 Isha")
        );
...
// For 2. Quran Kareem
    ...
    console.log("\n");
    console.log(
        chalk.bgMagentaBright.bold("2.1 Siparah"), 
        chalk.bgCyan.bold("2.2 Surah"), 
        chalk.bgYellow.bold("2.3 Verses"), 
        chalk.bgGray.bold("2.4 Words"), 
        chalk.bgRedBright.bold("2.5 Sajada")
    );
    history.push(menuAnswer.menu);
...
// For 3. Eid's
    ...
    console.log("\n");
    console.log(
        chalk.bgMagentaBright.bold("3.1 Eid-ul-Fitar"), 
        chalk.bgCyan.bold("3.2 Eid-ul-Adha"), 
        chalk.bgYellow.bold("3.3 Eid Milad-un-Nabi")
    );
...
// For 4. Prophet's
    ...
    console.log("\n");
    console.log(
        chalk.bgMagentaBright.bold("4.1 First Prophet"), 
        chalk.bgCyan.bold("4.2 Last Prophet"), 
        chalk.bgYellow.bold("4.3 Total Prophet")
    )
...
// For 5. Sahabah
    ...
    console.log("\n");
    console.log(
        chalk.bgMagentaBright.bold("5.1 Caliphs"), 
        chalk.bgCyan.bold("5.2 Total Sahabah")
    );
    ...
    if (sahabaAns.sahaba === "5.1 Caliphs") {
        ...
        console.log("\n");
        console.log(
            chalk.bgMagentaBright.bold("5.1.1 First Caliph"), 
            chalk.bgCyan.bold("5.1.2 Second Caliph"), 
            chalk.bgYellow.bold("5.1.3 Third Caliph"), 
            chalk.bgGray.bold("5.1.4 Forth Caliph")
        );
...
// For 7. Books
    ...
    console.log("\n");
    console.log(
        chalk.bgMagentaBright.bold("7.1 Torait"), 
        chalk.bgCyan.bold("7.2 Zaboor"), 
        chalk.bgYellow.bold("7.3 Injil"), 
        chalk.bgGray.bold("7.4 Quran Majeed")
    );
